...
def test_filter_by_state(test_inform_state):
    assert filter_by_state(inform_state, states_id=test_inform_state)


def test_filter_by_state1(test_inform_state1):
    assert filter_by_state(inform_state) == [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
